...
menu_text = _("""🇺🇿Kerakli bo'limni tanlang!
🇷🇺Выберите раздел!""")
...
contact_text = _("""❗️Hurmatli do‘stlar, agar sizda bizning faoliyatimiz 
bo‘yicha shikoyat, savol yoki takliflaringiz bo‘lsa, iltimos, 
ularni shu yerda yozib qoldiring.
☎️ Qo‘shimcha ma`lumot uchun +998 90 178-00-03 
yoki @mrsher8 ga murojaat qilishingiz mumkin.""")


register_list_text = _("""📍 Iltimos, o‘zingizga qulay bo‘lgan IT-Markazni tanlang 👇""")


robots_text = _("""📌 Mobil robototexnika
...
💰 Kursning narxi: 500 000 so‘m/oy.""")
...
💰 Kursning narxi: 1 000 000 so‘m/oy.""")


smm_text = _("""📌 SMM-mutaxassis
...
💰 Kursning narxi: 460 000 so‘m/oy.""")


graphics_text = _("""📌 Grafik va web dizayn
...
backend_text = _("""📌 Backend dasturlash
...
web_text = _("""📌 Android ilovalarni yaratish📲 Android - dunyodagi eng mashhur mobil platformadir. Android dasturchilar turli sohalarda faoliyat yuritishadi. Misol uchun, murakkab himoya darajasiga ega bo‘lgan onlayn-banking va onlayn-do‘kon uchun platformalar, ingliz tilini o‘rganish yoki oziq-ovqatlarni yetkazib berish xizmati uchun mobil ilovalarni ishlab chiqish.
...
filial_sergeli = _("""🏢 <b>IT Center - IT Center Sergeli</b>
